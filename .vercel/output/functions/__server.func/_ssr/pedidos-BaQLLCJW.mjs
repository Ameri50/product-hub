...
import { b as ArrowLeft, o as ShoppingBag } from "../_libs/lucide-react.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/pedidos-BaQLLCJW.js
...
function PedidosPage() {
	...
	const totalPedidos = (0, import_react.useMemo)(() => orders.length, [orders]);
			...
			children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
						...
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ShoppingBag, { className: "h-4 w-4 text-white" })
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h1", {
						className: "text-sm font-bold leading-tight text-slate-900 dark:text-white",
						children: "Pedidos"
					}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
						className: "text-[11px] text-slate-500 dark:text-slate-400",
						children: "Seguimiento de compras"
					})] })]
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("section", {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", {
							...
							children: "Compras registradas"
						}),
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							className: "mt-2 max-w-2xl text-sm text-slate-600 dark:text-slate-300",
							children: "Aquí se muestran los pedidos que llegan desde Firestore y se actualizan en tiempo real."
						})
				...
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", {
						...
						children: [totalPedidos, " registros"]
					})]
					...
					children: "Todavía no hay pedidos en Firestore."
					...
					children: orders.map((order) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("article", {
						...
						children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								...
								children: order.customerName ?? `Pedido ${order.id.slice(0, 6)}`
							}), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
								className: "text-sm text-slate-600 dark:text-slate-300",
								children: order.customerEmail ?? "Sin correo"
							})] }), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "text-left sm:text-right",
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									className: "text-sm font-medium text-indigo-600 dark:text-indigo-400",
									children: order.status ?? "Pendiente"
							...
							children: ["Creado: ", formatDate(order.createdAt)]
						})]
					}, order.id))
				})]
			})]
