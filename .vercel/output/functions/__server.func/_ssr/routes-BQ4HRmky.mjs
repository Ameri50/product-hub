...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-BQ4HRmky.js
...
var Dashboard = (0, import_react.lazy)(() => import("./Dashboard-BgwRf1IN.mjs").then((m) => ({ default: m.Dashboard })));
